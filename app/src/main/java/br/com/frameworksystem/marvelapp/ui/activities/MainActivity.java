...
public class MainActivity extends BaseActivity
    ...
    private static int menuPersonagem = 0;
    private static int menuComic = 1;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_personagens) {
            ...
            ft.replace(R.id.content_main, new CharacterFragment(menuPersonagem));
            ft.commit();
            ...
            FragmentTransaction ft = fm.beginTransaction();
            ft.replace(R.id.content_main, new CharacterFragment(menuComic));
            ft.commit();
